        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    use_crossing_over = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    guid = table.Column<Guid>(type: "uuid", nullable: false),
                    game_results_guid = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_generation_results", x => x.guid);
                    table.ForeignKey(
                        name: "fk_generation_results_game_results_game_results_guid",
                        column: x => x.game_results_guid,
                        principalSchema: "scheduled_research",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_generation_results_game_results_guid",
                schema: "scheduled_research",
                table: "GenerationResults",
                column: "game_results_guid",
                unique: true);
