...
public class CttPattern : IBehaviourPattern
{
     ...
     * CTT - [1,0,0,1,0,0]
     * CRTT - [1,0,0,1,0,1]
     * C then D - [1,0,0,0,1,1] тут можно еще интерпретировать. Если звезду * принимать за любое допустимое значение то C then D можно описать множеством решений: [1,0,*,0,*,1]
     * D then C Аналогично C then D [1,1,*,0,*,0]
     * D then CTT - [1,1,0,1,0,0]
     * D then RTT - [1,1,0,1,0,1]
     *
     */
